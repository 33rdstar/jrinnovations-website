...
const AppStore = () => {
  ...
  const DOWNLOAD_URL = 'https://firebasestorage.googleapis.com/v0/b/jr-app-store.firebasestorage.app/o/apks%2FYanga%201.0.3%20(b1).apk?alt=media&token=00a4fc82-d0cd-4a51-89ba-fcdbc961afe1';
