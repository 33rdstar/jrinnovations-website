...
// ─── Hook: reveal element once it enters the viewport ────────────────────────
...
// ─── Individual lazy-rendered service card ───────────────────────────────────
const ServiceCard = React.memo(({ service, colors }) => {
  ...
  return (
    <div ref={ref} id={service.id} className="scroll-mt-24">
      {visible ? (
        <div
          className={`${colors.bg} rounded-3xl p-8 md:p-12 shadow-xl border-l-8 ${colors.border} transform transition-all duration-500 hover:shadow-2xl hover:-translate-y-2`}
        >
          <div className="flex flex-col md:flex-row gap-8">
            {/* Icon */}
            <div className="flex-shrink-0">
              <div
                className={`w-20 h-20 bg-gradient-to-br ${colors.gradient} rounded-2xl flex items-center justify-center text-white shadow-lg`}
              >
                {service.icon}
              </div>
            </div>
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  {service.features.map((feature) => (
                    <div key={feature} className="flex items-start space-x-2">
                      <div
                        className={`w-2 h-2 rounded-full ${colors.bg} ${colors.border} border-2 mt-2 flex-shrink-0`}
                      />
    ...
    () => [
      {
        ...
        description:
          'We design and develop bespoke software applications that perfectly align with your business processes and goals. Our custom solutions streamline operations, increase efficiency, and give you a competitive edge.',
        features: [
      ...
      {
        id: 'web-applications',
        icon: <Globe className="w-12 h-12" aria-hidden="true" />,
        title: 'Web Applications',
        tagline: 'Responsive, modern websites that drive results',
        description:
          'From stunning landing pages to complex web applications, we create responsive, fast, and user-friendly websites that engage your audience and achieve your business objectives.',
        features: [
      ...
      {
        id: 'mobile-apps',
        icon: <Smartphone className="w-12 h-12" aria-hidden="true" />,
        title: 'Mobile App Development',
        tagline: 'iOS and Android apps that users love',
        description:
          'We build native and cross-platform mobile applications that deliver exceptional user experiences on both iOS and Android devices, helping you reach your audience wherever they are.',
        features: [
      ...
      },
      {
        ...
        description:
          'Our experienced consultants help you make informed technology decisions, optimize your IT infrastructure, and develop comprehensive digital strategies that drive business growth.',
        features: [
      ...
      {
        id: 'ecommerce',
        icon: <ShoppingCart className="w-12 h-12" aria-hidden="true" />,
        title: 'E-Commerce Solutions',
        tagline: 'Complete online store setup and management',
        description:
          'Launch and grow your online business with our comprehensive e-commerce solutions. We handle everything from store setup to payment processing and inventory management.',
        features: [
      ...
      },
      {
        ...
        icon: <Network className="w-12 h-12" aria-hidden="true" />,
        title: 'System Integration',
        tagline: 'Seamless connection of your business tools',
        description:
          'We connect your disparate systems and applications to work together harmoniously, eliminating data silos and improving workflow efficiency across your organization.',
        features: [
          'API development and integration',
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl lg:max-w-none">
                Cutting-edge technology solutions that propel your business forward. From custom
                software to mobile apps, we transform your digital vision into reality.
              </p>
              <Link
                to="/#contact"
            ...
            {/* Phone mockup — visible above fold, no lazy loading */}
          ...
          <div className="space-y-24">
            {services.map((service) => (
              <ServiceCard
                key={service.id}
                service={service}
                colors={colorVariants[service.color]}
              />
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-blue-600 to-blue-800 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-white mb-8">
            Let's discuss how our technology solutions can transform your business. Our team is
